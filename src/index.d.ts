...
interface StaticMath extends MQInstanceMethods {}

interface EditableMathField extends MQInstanceMethods {
  /**
   ...
   */
  config: (new_config: MQConfig) => void,
...
interface MQInterface {
  ...
  MathField: (el: HTMLElement, config?: MQConfig) => EditableMathField,

  MQ: (el: HTMLElement) => EditableMathField
}

declare class MathQuill {
  getInterface(v: number): MQInterface;
};
